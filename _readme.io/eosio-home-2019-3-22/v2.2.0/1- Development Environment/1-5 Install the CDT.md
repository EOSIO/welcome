...
If the build command fails with a missing keg, such as "dep", install it and install the submodules, then try building again.
[block:code]
{
  "codes": [
    {
      "code": "# failed with missing dep keg\nbrew install dep\n\n# install the git submodules\ngit submodule update --init --recursive\n\n# try the build again\n./build.sh",
      "language": "shell"
    }
  ]
}
