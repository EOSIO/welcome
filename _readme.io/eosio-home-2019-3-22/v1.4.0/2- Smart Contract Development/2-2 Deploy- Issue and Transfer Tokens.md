...
[/block]
Now that account `alice` has been issued tokens, transfer some of them to account `bob`. We will indicate that `alice` authorized this action using the argument `-p alice@active`.
[block:code]
{
  "codes": [
    {
