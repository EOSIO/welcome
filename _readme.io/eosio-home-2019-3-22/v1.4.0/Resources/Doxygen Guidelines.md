---
title: "Doxygen Guidelines"
excerpt: ""
---
## Introduction
Doxygen is a documentation generator; A tool for writing software reference documentation. The documentation is written within the code, and is thus relatively easy to keep up to date.
...
After downloading and installing Doxygen, it needs to be run to analyze all source code comments and build the corresponding documentation.
...
So to generate or update the EOSIO documentation from the command line, navigate to the root folder of the EOSIO repository and trigger the document generation as follows
...
The list of commands recognized by doxygen is quite exhaustive; (An alphabetically sorted list of all commands can be found here: http://www.stack.nl/~dimitri/doxygen/manual/commands.html).
