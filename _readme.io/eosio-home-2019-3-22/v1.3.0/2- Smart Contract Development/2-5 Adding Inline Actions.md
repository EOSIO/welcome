...
[/block]
The `eosio.code` authority is a pseudo authority implemented to enhance security, and enable contracts to sign inline actions.
[block:api-header]
{
...
[block:api-header]
{
  "title": "Step 7: Updating the EOSIO_ABI macro"
}
[/block]
...
[block:code]
{
  "codes": [
    {
      "code": "  EOSIO_ABI( addressbook, (upsert)(erase)(notify) )",
      "language": "cplusplus"
    }
  ]
}
