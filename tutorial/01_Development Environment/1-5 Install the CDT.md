...
[block:code]
{
  "codes": [
    {
      "code": "wget https://github.com/EOSIO/eosio.cdt/releases/download/v1.6.0/eosio.cdt_1.6.0-1_amd64.deb\nsudo apt install ./eosio.cdt_1.6.0-1_amd64.deb",
      "language": "shell"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "wget https://github.com/EOSIO/eosio.cdt/releases/download/v1.6.0/eosio.cdt-1.6.0-1.centos-x86_64.rpm\n\nsudo yum install ./eosio.cdt-1.6.0-1.centos-x86_64.rpm",
      "language": "shell"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "git clone --recursive https://github.com/eosio/eosio.cdt --branch v1.6.0 --single-branch\ncd eosio.cdt",
      "language": "text"
    }
  ]
}
