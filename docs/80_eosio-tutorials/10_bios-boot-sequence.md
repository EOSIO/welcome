...
For instructions on creating a wallet and importing the keys, see the [Create development wallet](../60_eosio-getting-started-guide/25_development-environment/50_development-wallet.md) tutorial.
...
For commands on creating new accounts, see the [`Create test accounts`](../60_eosio-getting-started-guide/25_development-environment/70_accounts-and-test-accounts.md) tutorial.

For commands on issuing, allocating and transferring token between accounts, see the
[`Deploy, Issue and Transfer Tokens`](../70_smart-contract-getting-started/20_deploy-issue-and-transfer-tokens.md) section.
