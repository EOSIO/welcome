...
You can also specify authorities other than a public key for this permission, for example, a set of other accounts. Check [account permission](https://developers.eos.io/manuals/eos/v2.0/cleos/command-reference/set/set-account) for more details.
