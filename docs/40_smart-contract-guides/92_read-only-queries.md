...
* The EOSIO platform software, version 2.2. or greater, click on this link for instructions on [installing EOSIO binaries](https://developers.eos.io/manuals/eos/latest/install/install-prebuilt-binaries)
* You understand how to build and deploy smart contracts
