...
You can also specify authorities other than a public key for this permission, for example, a set of other accounts. Check [account permission](/manuals/eos/latest/cleos/command-reference/set/set-account) for more details.
