...
Throughout these tutorials the accounts `bob` and `alice` are used. Create two accounts using [cleos create account](https://developers.eos.io/manuals/eos/v2.1/cleos/command-reference/create/account)
...
Check which public key is associated with `alice` using [cleos get account](https://developers.eos.io/manuals/eos/v2.1/cleos/command-reference/get/account)
