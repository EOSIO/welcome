...
See the [nodeos manual](https://developers.eos.io/manuals/eos/v2.0/nodeos/index) for detailed information on how to use `nodeos`.  
...
You can also use the [Block.one's official EOSIO Testnet.](https://testnet.eos.io/) To learn how to set up an account and use the EOSIO Testnet click here [EOSIO Testnet Quick Start Guide.](https://developers.eos.io/welcome/v2.0/quick-start-guides/testnet-quick-start-guide/index)
...
Further Reading
For more information on this topic, see the [Accounts and Permissions](https://developers.eos.io/welcome/v2.0/protocol/accounts_and_permissions) section.

### How can I change private keys for accounts?

Use the [cleos set account](https://developers.eos.io/manuals/eos/v2.0/cleos/command-reference/set/set-account) command.
...
to update the key pairs associated with an account permission. This command replaces the existing authority structure associated with the permission. Keys are stored in the authority, which is referenced by the permission, which is referenced by the account. See [Account and Permissions](https://developers.eos.io/welcome/v2.0/protocol/accounts_and_permissions) for details.
...
For more information on the EOSIO consensus model, see [Consensus Protocol.](https://developers.eos.io/welcome/v2.0/protocol/consensus_protocol/)
