...
For more information about these concepts, see the [_Accounts and Permissions_](../60_eosio-protocol-guides/40_accounts_and_permissions.md) documentation.
...
For more information about DPOS BFT, see [EOSIO Consensus](../60_eosio-protocol-guides/10_consensus_protocol.md#3-eosio-consensus-dpos--abft).
